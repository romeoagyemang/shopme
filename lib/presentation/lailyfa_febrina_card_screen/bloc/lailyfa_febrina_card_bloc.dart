...
import 'package:shopme/presentation/lailyfa_febrina_card_screen/models/lailyfa_febrina_card_model.dart';
...
class LailyfaFebrinaCardBloc
  ...
  _onInitialize(
    ...
    emit(state.copyWith(
        ...
        cardHolderNameEditTextController: TextEditingController()));
  }
}
