...
import 'package:shopme/presentation/filter_screen/models/filter_model.dart';
...
class FilterBloc extends Bloc<FilterEvent, FilterState> {
  ...
  _updateChipView3(
    ...
    List<ShowonlychipviewItemModel> newList =
        List<ShowonlychipviewItemModel>.from(
            state.filterModelObj!.showonlychipviewItemList);
    newList[event.index] = newList[event.index].copyWith(
      isSelected: event.isSelected,
    );
    emit(state.copyWith(
        filterModelObj:
            state.filterModelObj?.copyWith(showonlychipviewItemList: newList)));
  }
  ...
  List<ShowonlychipviewItemModel> fillShowonlychipviewItemList() {
    return List.generate(11, (index) => ShowonlychipviewItemModel());
  }
  ...
  _onInitialize(
    ...
    emit(state.copyWith(
      ...
      showonlychipviewItemList: fillShowonlychipviewItemList(),
    )));
  }
}
