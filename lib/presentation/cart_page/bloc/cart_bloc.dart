...
import 'package:shopme/presentation/cart_page/models/cart_model.dart';
...
class CartBloc extends Bloc<CartEvent, CartState> {
  ...
  List<CartlistItemModel> fillCartlistItemList() {
    return [
      CartlistItemModel(
          nikeAirexecutive: ImageConstant.imgImage161,
          nikeAirZoomPegasus: "Nike Air executive",
          price: " 320",
          one: "1"),
      CartlistItemModel(
          nikeAirexecutive: ImageConstant.imgImage121,
          nikeAirZoomPegasus: "Nike Air smoke",
          price: "400",
          one: "1")
    ];
  }
